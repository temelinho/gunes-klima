...
(function () {
  ...
  var TR = {
    ...
    'be.hero.badge': '7/24 Alanya Beyaz Eşya Servisi',
    'be.hero.title': 'Alanya Beyaz Eşya Servisi ve Tamiri',
    'be.hero.subtitle': 'Buzdolabı, çamaşır makinesi, bulaşık makinesi, kurutma makinesi, fırın, ocak ve ankastre cihazlarınızın tüm marka arızalarını Alanya genelinde adreste, aynı gün ve garantili olarak onarıyoruz. Klima servisimizin güvencesiyle, tek telefonla kapınızdayız.',
    'be.svc.tag': 'Beyaz Eşya Servisimiz',
    'be.svc.title': 'Tamir Ettiğimiz Beyaz Eşyalar',
    'be.svc.desc': "Marka fark etmeksizin tüm beyaz eşya arızalarınıza Alanya'da aynı gün, adreste ve garantili servis veriyoruz.",
    'be.svc.fridge.title': 'Buzdolabı Tamiri',
    'be.svc.fridge.text': 'Soğutmayan, çalışmayan, su yapan veya ses çıkaran buzdolapları için arıza tespiti, gaz dolumu, termostat, kompresör ve fan onarımı. No-frost ve gardırop tipi tüm modeller.',
    'be.svc.washer.title': 'Çamaşır Makinesi Tamiri',
    'be.svc.washer.text': 'Su almayan, su boşaltmayan, sıkma yapmayan, ses ve titreşim yapan çamaşır makineleri için pompa, rulman, tambur, kayış ve elektronik kart onarımı ile arıza kodu çözümü.',
    'be.svc.dish.title': 'Bulaşık Makinesi Tamiri',
    'be.svc.dish.text': 'Su almayan, ısıtmayan, iyi yıkamayan veya hata kodu veren bulaşık makineleri için tahliye pompası, rezistans, su giriş vanası ve elektronik kart onarımı yapıyoruz.',
    'be.svc.dryer.title': 'Kurutma Makinesi Tamiri',
    'be.svc.dryer.text': 'Kurutmayan, ısınmayan, çalışmayan kurutma makineleri için rezistans, ısı pompası, fan, nem sensörü ve elektronik kart arızalarını tespit edip garantili şekilde onarıyoruz.',
    'be.svc.oven.title': 'Fırın, Ocak ve Ankastre Tamiri',
    'be.svc.oven.text': 'Isıtmayan fırın, çalışmayan ocak, arızalı ankastre set ve davlumbazlar için rezistans, termostat, ateşleme, gaz vanası ve elektronik kart onarımı. Gazlı ve elektrikli tüm modeller.',
    'be.svc.other.title': 'Derin Dondurucu \u0026 Diğer Cihazlar',
    'be.svc.other.text': 'Derin dondurucu, mikrodalga, aspiratör ve diğer beyaz eşyalarınız için de servis veriyoruz. Arızanızı arayarak bildirin, uygun ekibimizi aynı gün adresinize yönlendirelim.',
    'be.brands.tag': 'Servis Verdiğimiz Markalar',
    'be.brands.title': 'Tüm Beyaz Eşya Markaları',
    'be.brands.desc': 'Marka ayırt etmeksizin tüm beyaz eşyalarınıza servis veriyoruz. Orijinal ve muadil yedek parça temin ediyoruz.',
    'be.brands.note': 'Markanızı listede görmeseniz de arayın; büyük ihtimalle servisimiz kapsamındadır.',
    'be.why.tag': 'Neden Güneş Klima?',
    'be.why.title': 'Beyaz Eşya Servisinde Neden Biz?',
    'be.why.desc': 'Alanya geneli mobil servisimizle beyaz eşya arızalarınıza hızlı, güvenilir ve garantili çözüm sunuyoruz.',
    'be.why.card1.title': 'Aynı Gün Servis',
    'be.why.card1.text': 'Alanya içinde 7/24 hızlı ulaşımla arıza bildiriminizi oluşturduğunuz gün adresinize gelir, cihazınızı onarırız.',
    'be.why.card2.title': 'Garantili İşçilik',
    'be.why.card2.text': 'Yaptığımız her tamir ve değiştirdiğimiz her parça garantilidir. Aynı arıza tekrarlarsa yanınızdayız.',
    'be.why.card3.title': 'Tüm Markalara Servis',
    'be.why.card3.text': 'Arçelik, Beko, Bosch, Siemens ve tüm markaların cihazlarına orijinal ve muadil yedek parça ile servis veriyoruz.',
    'be.why.card4.title': 'Şeffaf Fiyat',
    'be.why.card4.text': 'Arıza tespitinden sonra net fiyatı önceden söyler, onayınız olmadan işleme başlamayız. Sürpriz ek ücret yok.',
    'be.faq.tag': 'Sıkça Sorulanlar',
    'be.faq.title': 'Beyaz Eşya Tamiri Hakkında Sorular',
    'be.faq.desc': 'Buzdolabı, çamaşır ve bulaşık makinesi arızaları hakkında en çok merak edilenleri yanıtladık.',
    'be.faq.q1.q': 'Buzdolabı soğutmuyorsa sebebi ne olabilir?',
    'be.faq.q1.a': "Buzdolabının soğutmaması genellikle gaz kaçağı, termostat arızası, kompresör sorunu veya fan/defrost sistemindeki bir tıkanıklıktan kaynaklanır. Alanya'da aynı gün adrese gelip arızayı tespit eder, gaz dolumu veya parça değişimini garantili olarak yaparız.",
    'be.faq.q2.q': 'Çamaşır makinesi su almıyor / su boşaltmıyorsa ne yapmalı?',
    'be.faq.q2.a': 'Su almama sorunu genellikle giriş vanası, su filtresi tıkanıklığı veya elektronik kartla; su boşaltmama ise pompa, tahliye hortumu tıkanıklığı veya arızalı tahliye pompasıyla ilgilidir. Servisimiz arızayı yerinde tespit edip aynı gün onarır.',
    'be.faq.q3.q': 'Bulaşık makinesi hata kodu veriyor, tamir edilebilir mi?',
    'be.faq.q3.a': 'Evet. Bulaşık makinelerindeki hata kodları çoğunlukla su alma, ısıtma, tahliye veya sensör arızalarına işaret eder. Markası fark etmeksizin hata kodunu okuyup arızanın kaynağını giderir, gerekli parçayı değiştiririz.',
    'be.faq.q4.q': 'Hangi beyaz eşya markalarına servis veriyorsunuz?',
    'be.faq.q4.a': 'Arçelik, Beko, Bosch, Siemens, Samsung, LG, Vestel, Profilo, Altus, Grundig, Whirlpool ve diğer tüm markaların buzdolabı, çamaşır makinesi, bulaşık makinesi, kurutma makinesi, fırın ve ocaklarına servis veriyoruz.',
    'be.faq.q5.q': 'Beyaz eşya tamiri için servis ücreti ne kadar?',
    'be.faq.q5.a': 'Ücret; cihazın türüne, arızanın kapsamına ve değişecek parçaya göre belirlenir. Arıza tespiti sonrası işlem öncesinde net fiyat söyler, onayınız olmadan işleme başlamayız. Sürpriz ek ücret yoktur.',
    'be.faq.q6.q': 'Aynı gün servis geliyor musunuz?',
    'be.faq.q6.a': "Evet. Alanya ve tüm mahallelerine mobil servis araçlarımızla aynı gün, 7/24 adrese servis sağlıyoruz. Yaptığımız tamir ve değiştirilen parçalar garantilidir.",
    'be.regions.tag': 'Yakın Hizmet Noktaları',
    'be.regions.title': 'Beyaz Eşya Servisi Verdiğimiz Bölgeler',
    'be.regions.desc': "Mobil servis araçlarımızla Alanya'nın tüm mahallelerine ve çevre bölgelerine aynı gün beyaz eşya servisi sağlıyoruz.",
    'be.regions.note': "Alanya'nın tüm mahallelerine ve çevre ilçelerine 7/24 hızlı mobil servisimiz vardır.",
    'be.contact.tag': 'İletişime Geçin',
    'be.contact.title': 'Beyaz Eşya Arızanız İçin Ulaşın',
    'be.contact.desc': 'Beyaz eşya arızanız için bize telefon, WhatsApp veya e-posta ile 7/24 ulaşabilirsiniz. Form yok; en hızlı çözüm için doğrudan arayın.',
    'be.details.noform.text': 'Beyaz eşya arızası acil müdahale gerektirir. Size en hızlı sürede yardımcı olabilmemiz için form doldurmak yerine doğrudan <strong>Hemen Arayın</strong> veya <strong>WhatsApp üzerinden</strong> iletişime geçin.',
    'be.footer.desc': "Alanya'da 7/24 güvenilir klima ve beyaz eşya servisi sunan profesyonel çözüm ortağınız. Buzdolabı, çamaşır ve bulaşık makinesi, fırın ve tüm beyaz eşyalarınız için yanınızdayız.",
    'be.footer.brands': "Servis Markaları"
  };
  ...
  var EN = {
    ...
    'footer.tagline': 'Designed with care for local business SEO.',
    'be.hero.badge': '24/7 Alanya Home Appliance Service',
    'be.hero.title': 'Home Appliance Service and Repair in Alanya',
    'be.hero.subtitle': 'We repair all-brand faults on refrigerators, washing machines, dishwashers, dryers, ovens, hobs and built-in appliances across Alanya — at your address, same-day and guaranteed. With the assurance of our AC service, we are at your door with a single call.',
    'be.svc.tag': 'Our Appliance Service',
    'be.svc.title': 'Appliances We Repair',
    'be.svc.desc': 'Regardless of brand, we provide same-day, on-site and guaranteed service for all your appliance faults in Alanya.',
    'be.svc.fridge.title': 'Refrigerator Repair',
    'be.svc.fridge.text': 'Fault diagnosis, gas refill, thermostat, compressor and fan repair for refrigerators that do not cool, do not run, leak water or make noise. All no-frost and side-by-side models.',
    'be.svc.washer.title': 'Washing Machine Repair',
    'be.svc.washer.text': 'Pump, bearing, drum, belt and circuit board repair plus error code troubleshooting for washing machines that do not fill, drain, spin, or that vibrate and make noise.',
    'be.svc.dish.title': 'Dishwasher Repair',
    'be.svc.dish.text': 'We repair drain pumps, heating elements, water inlet valves and circuit boards for dishwashers that do not fill, heat, clean properly or show error codes.',
    'be.svc.dryer.title': 'Dryer Repair',
    'be.svc.dryer.text': 'We diagnose and repair heating element, heat pump, fan, humidity sensor and circuit board faults in dryers that do not dry, heat up or run — all guaranteed.',
    'be.svc.oven.title': 'Oven, Hob \u0026 Built-in Appliance Repair',
    'be.svc.oven.text': 'Heating element, thermostat, ignition, gas valve and circuit board repair for ovens that do not heat, hobs that do not work, faulty built-in sets and range hoods. All gas and electric models.',
    'be.svc.other.title': 'Deep Freezer \u0026 Other Appliances',
    'be.svc.other.text': 'We also service deep freezers, microwaves, range hoods and other home appliances. Call us with your fault details and we will dispatch the right team to your address the same day.',
    'be.brands.tag': 'Brands We Service',
    'be.brands.title': 'All Home Appliance Brands',
    'be.brands.desc': 'We service all your home appliances regardless of brand. We supply original and compatible spare parts.',
    'be.brands.note': "Even if you don't see your brand listed, call us — it is most likely covered by our service.",
    'be.why.tag': 'Why Güneş Klima?',
    'be.why.title': 'Why Choose Us for Appliance Service?',
    'be.why.desc': 'With our mobile service across all of Alanya, we offer fast, reliable and guaranteed solutions for your appliance faults.',
    'be.why.card1.title': 'Same-Day Service',
    'be.why.card1.text': 'With fast 24/7 access throughout Alanya, we come to your address and repair your appliance on the same day you report the fault.',
    'be.why.card2.title': 'Guaranteed Workmanship',
    'be.why.card2.text': 'Every repair we make and every part we replace is guaranteed. If the same fault recurs, we are here for you.',
    'be.why.card3.title': 'Service for All Brands',
    'be.why.card3.text': 'We service appliances from Arçelik, Beko, Bosch, Siemens and all other brands with original and compatible spare parts.',
    'be.why.card4.title': 'Transparent Pricing',
    'be.why.card4.text': 'After diagnosing the fault, we state the exact price upfront and do not start work without your approval. No surprise extra charges.',
    'be.faq.tag': 'Frequently Asked Questions',
    'be.faq.title': 'Questions About Appliance Repair',
    'be.faq.desc': 'We have answered the most frequently asked questions about refrigerator, washing machine and dishwasher faults.',
    'be.faq.q1.q': 'Why is my refrigerator not cooling?',
    'be.faq.q1.a': 'A refrigerator not cooling is usually caused by a gas leak, thermostat fault, compressor issue or a blockage in the fan/defrost system. We come to your address the same day in Alanya, diagnose the fault and carry out gas refills or part replacements with a guarantee.',
    'be.faq.q2.q': 'What should I do if my washing machine is not filling or draining water?',
    'be.faq.q2.a': 'Not filling is usually related to the inlet valve, water filter blockage or circuit board; not draining is related to the pump, drain hose blockage or a faulty drain pump. Our service diagnoses the fault on site and repairs it the same day.',
    'be.faq.q3.q': 'My dishwasher is showing an error code — can it be repaired?',
    'be.faq.q3.a': 'Yes. Error codes in dishwashers usually point to water inlet, heating, draining or sensor faults. Regardless of brand, we read the error code, fix the root cause and replace the necessary part.',
    'be.faq.q4.q': 'Which home appliance brands do you service?',
    'be.faq.q4.a': 'We service refrigerators, washing machines, dishwashers, dryers, ovens and hobs from Arçelik, Beko, Bosch, Siemens, Samsung, LG, Vestel, Profilo, Altus, Grundig, Whirlpool and all other brands.',
    'be.faq.q5.q': 'How much does appliance repair service cost?',
    'be.faq.q5.a': 'The fee depends on the type of appliance, the scope of the fault and the part to be replaced. After diagnosis, we state the exact price before starting work and do not proceed without your approval. No surprise extra charges.',
    'be.faq.q6.q': 'Do you provide same-day service?',
    'be.faq.q6.a': 'Yes. We provide same-day, 24/7 on-site service to Alanya and all its neighbourhoods with our mobile service vehicles. All our repairs and replaced parts are guaranteed.',
    'be.regions.tag': 'Nearby Service Areas',
    'be.regions.title': 'Areas We Provide Appliance Service',
    'be.regions.desc': 'With our mobile service vehicles, we provide same-day appliance service to all neighbourhoods of Alanya and surrounding areas.',
    'be.regions.note': 'We have a fast 24/7 mobile service covering all neighbourhoods of Alanya and surrounding districts.',
    'be.contact.tag': 'Get in Touch',
    'be.contact.title': 'Contact Us for Appliance Faults',
    'be.contact.desc': 'For appliance faults, you can reach us 24/7 by phone, WhatsApp or email. No forms — call us directly for the fastest solution.',
    'be.details.noform.text': 'Appliance faults require urgent attention. To help you as quickly as possible, please <strong>Call Now</strong> or contact us <strong>via WhatsApp</strong> directly instead of filling out a form.',
    'be.footer.desc': 'Your professional solution partner in Alanya, offering reliable 24/7 air conditioner and home appliance services. We are here for your refrigerator, washing machine, dishwasher, oven, and all home appliances.',
    'be.footer.brands': 'Brands Serviced'
  };
  ...
  var DE = {
    ...
    'be.hero.badge': '24/7 Haushaltsgeräteservice in Alanya',
    'be.hero.title': 'Haushaltsgeräte-Service und Reparatur in Alanya',
    'be.hero.subtitle': 'Wir reparieren markenübergreifend Kühlschränke, Wasch- und Geschirrspülmaschinen, Trockner, Backöfen, Kochfelder und Einbaugeräte in ganz Alanya — bei Ihnen zu Hause, taggleich und garantiert. Mit der Zuverlässigkeit unseres Klimaservice sind wir mit einem Anruf bei Ihnen.',
    'be.svc.tag': 'Unser Geräteservice',
    'be.svc.title': 'Geräte, die wir reparieren',
    'be.svc.desc': 'Unabhängig von der Marke bieten wir in Alanya taggleichen, Vor-Ort- und garantierten Service für alle Ihre Gerätedefekte.',
    'be.svc.fridge.title': 'Kühlschrankreparatur',
    'be.svc.fridge.text': 'Fehlerdiagnose, Gasbefüllung, Thermostat-, Kompressor- und Lüfterreparatur für Kühlschränke, die nicht kühlen, nicht laufen, Wasser verlieren oder Geräusche machen. Alle No-Frost- und Side-by-Side-Modelle.',
    'be.svc.washer.title': 'Waschmaschinenreparatur',
    'be.svc.washer.text': 'Pumpen-, Lager-, Trommel-, Keilriemen- und Platinreparatur sowie Fehlercode-Behebung für Waschmaschinen, die kein Wasser ziehen, nicht abpumpen, nicht schleudern oder vibrieren.',
    'be.svc.dish.title': 'Geschirrspülerreparatur',
    'be.svc.dish.text': 'Wir reparieren Ablaufpumpen, Heizelemente, Wasserzulaufventile und Platinen für Geschirrspüler, die kein Wasser ziehen, nicht heizen, schlecht spülen oder Fehlercodes anzeigen.',
    'be.svc.dryer.title': 'Trocknerreparatur',
    'be.svc.dryer.text': 'Wir diagnostizieren und reparieren garantiert Heizelement-, Wärmepumpen-, Lüfter-, Feuchtigkeitssensor- und Platinendefekte bei Trocknern, die nicht trocknen, nicht heizen oder nicht starten.',
    'be.svc.oven.title': 'Backofen-, Kochfeld- \u0026 Einbaugerätereparatur',
    'be.svc.oven.text': 'Heizelement-, Thermostat-, Zündungs-, Gasventil- und Platinenreparatur für Backöfen, die nicht heizen, Kochfelder, die nicht funktionieren, defekte Einbausets und Dunstabzugshauben. Alle Gas- und Elektromodelle.',
    'be.svc.other.title': 'Gefriertruhe \u0026 andere Geräte',
    'be.svc.other.text': 'Wir warten auch Gefriertruhen, Mikrowellen, Dunstabzugshauben und andere Haushaltsgeräte. Rufen Sie uns mit Ihren Störungsdetails an und wir schicken noch am selben Tag das passende Team.',
    'be.brands.tag': 'Marken, die wir warten',
    'be.brands.title': 'Alle Haushaltsgerätemarken',
    'be.brands.desc': 'Wir warten all Ihre Haushaltsgeräte unabhängig von der Marke. Wir beschaffen Original- und kompatible Ersatzteile.',
    'be.brands.note': 'Selbst wenn Sie Ihre Marke nicht in der Liste sehen, rufen Sie an — sie ist höchstwahrscheinlich abgedeckt.',
    'be.why.tag': 'Warum Güneş Klima?',
    'be.why.title': 'Warum wir für Ihren Geräteservice?',
    'be.why.desc': 'Mit unserem mobilen Service in ganz Alanya bieten wir schnelle, zuverlässige und garantierte Lösungen für Ihre Gerätedefekte.',
    'be.why.card1.title': 'Service am selben Tag',
    'be.why.card1.text': 'Dank schnellem 24/7-Zugang in ganz Alanya kommen wir noch am Tag Ihrer Meldung und reparieren Ihr Gerät.',
    'be.why.card2.title': 'Garantierte Arbeit',
    'be.why.card2.text': 'Jede Reparatur und jedes Ersatzteil ist garantiert. Sollte der gleiche Defekt erneut auftreten, sind wir für Sie da.',
    'be.why.card3.title': 'Service für alle Marken',
    'be.why.card3.text': 'Wir warten Geräte von Arçelik, Beko, Bosch, Siemens und allen anderen Marken mit Original- und kompatiblen Ersatzteilen.',
    'be.why.card4.title': 'Transparente Preise',
    'be.why.card4.text': 'Nach der Fehlerdiagnose nennen wir den genauen Preis im Voraus und beginnen nicht ohne Ihre Zustimmung. Keine versteckten Zusatzkosten.',
    'be.faq.tag': 'Häufig gestellte Fragen',
    'be.faq.title': 'Fragen zur Gerätereparatur',
    'be.faq.desc': 'Wir haben die häufigsten Fragen zu Kühlschrank-, Waschmaschinen- und Geschirrspülerdefekten beantwortet.',
    'be.faq.q1.q': 'Warum kühlt mein Kühlschrank nicht?',
    'be.faq.q1.a': 'Ein nicht kühlender Kühlschrank liegt meist an Gasleck, Thermostatdefekt, Kompressorproblem oder einer Verstopfung im Lüfter-/Abtausystem. Wir kommen in Alanya noch am selben Tag zu Ihnen, diagnostizieren den Fehler und führen Gasbefüllung oder Teiletausch garantiert durch.',
    'be.faq.q2.q': 'Was tun, wenn die Waschmaschine kein Wasser zieht oder nicht abpumpt?',
    'be.faq.q2.a': 'Kein Wasserzulauf hängt meist mit Einlassventil, Wasserfilter-Verstopfung oder Platine zusammen; fehlendes Abpumpen mit Pumpe, Ablaufschlauch-Verstopfung oder defekter Ablaufpumpe. Unser Service diagnostiziert den Fehler vor Ort und repariert ihn taggleich.',
    'be.faq.q3.q': 'Mein Geschirrspüler zeigt einen Fehlercode — ist er reparierbar?',
    'be.faq.q3.a': 'Ja. Fehlercodes bei Geschirrspülern weisen meist auf Wasserzulauf-, Heizungs-, Ablauf- oder Sensordefekte hin. Unabhängig von der Marke lesen wir den Code aus, beheben die Ursache und tauschen das nötige Teil.',
    'be.faq.q4.q': 'Welche Haushaltsgerätemarken warten Sie?',
    'be.faq.q4.a': 'Wir warten Kühlschränke, Waschmaschinen, Geschirrspüler, Trockner, Backöfen und Kochfelder von Arçelik, Beko, Bosch, Siemens, Samsung, LG, Vestel, Profilo, Altus, Grundig, Whirlpool und allen anderen Marken.',
    'be.faq.q5.q': 'Was kostet die Gerätereparatur?',
    'be.faq.q5.a': 'Die Gebühr hängt vom Gerätetyp, Fehlerumfang und dem zu ersetzenden Teil ab. Nach der Diagnose nennen wir den genauen Preis vor Arbeitsbeginn und starten nicht ohne Ihre Zustimmung. Keine versteckten Zusatzkosten.',
    'be.faq.q6.q': 'Bieten Sie Service am selben Tag?',
    'be.faq.q6.a': 'Ja. Wir bieten taggleichen 24/7-Vor-Ort-Service in Alanya und allen Stadtteilen mit unseren mobilen Servicefahrzeugen. Alle Reparaturen und Ersatzteile sind garantiert.',
    'be.regions.tag': 'Nahegelegene Servicegebiete',
    'be.regions.title': 'Gebiete für Geräteservice',
    'be.regions.desc': 'Mit unseren mobilen Servicefahrzeugen bieten wir allen Stadtteilen Alanyas und Umgebung taggleichen Geräteservice.',
    'be.regions.note': 'Wir bieten schnellen 24/7-Mobilservice für alle Stadtteile Alanyas und die umliegenden Bezirke.',
    'be.contact.tag': 'Kontaktieren Sie uns',
    'be.contact.title': 'Kontakt bei Gerätedefekten',
    'be.contact.desc': 'Bei Gerätedefekten erreichen Sie uns rund um die Uhr per Telefon, WhatsApp oder E-Mail. Kein Formular — rufen Sie direkt an für die schnellste Lösung.',
    'be.details.noform.text': 'Gerätedefekte erfordern dringendes Handeln. Damit wir Ihnen schnellstmöglich helfen können, <strong>rufen Sie uns bitte direkt an</strong> oder kontaktieren Sie uns <strong>über WhatsApp</strong> statt ein Formular auszufüllen.',
    'be.footer.desc': 'Ihr professioneller Lösungspartner in Alanya für zuverlässigen 24/7-Klima- und Haushaltsgeräteservice. Wir sind für Sie da bei Kühlschrank, Waschmaschine, Geschirrspüler, Backofen und allen Haushaltsgeräten.',
    'be.footer.brands': 'Servicemarken'
  };
  ...
  var RU = {
    ...
    'be.hero.badge': 'Круглосуточный сервис бытовой техники в Алании',
    'be.hero.title': 'Сервис и ремонт бытовой техники в Алании',
    'be.hero.subtitle': 'Мы ремонтируем холодильники, стиральные и посудомоечные машины, сушилки, духовки, варочные панели и встроенную технику всех марок по всей Алании — на дому, в тот же день и с гарантией. С надёжностью нашего климатического сервиса мы у вашей двери по одному звонку.',
    'be.svc.tag': 'Наш сервис бытовой техники',
    'be.svc.title': 'Техника, которую мы ремонтируем',
    'be.svc.desc': 'Независимо от марки, мы предоставляем сервис в тот же день, на дому и с гарантией для всех неисправностей вашей бытовой техники в Алании.',
    'be.svc.fridge.title': 'Ремонт холодильников',
    'be.svc.fridge.text': 'Диагностика, заправка газом, ремонт термостата, компрессора и вентилятора для холодильников, которые не охлаждают, не работают, текут или шумят. Все модели No-Frost и Side-by-Side.',
    'be.svc.washer.title': 'Ремонт стиральных машин',
    'be.svc.washer.text': 'Ремонт насоса, подшипников, барабана, ремня и электронной платы, а также устранение кодов ошибок для стиральных машин, которые не набирают воду, не сливают, не отжимают или вибрируют.',
    'be.svc.dish.title': 'Ремонт посудомоечных машин',
    'be.svc.dish.text': 'Мы ремонтируем сливные насосы, нагревательные элементы, впускные клапаны и электронные платы для посудомоечных машин, которые не набирают воду, не нагревают, плохо моют или показывают коды ошибок.',
    'be.svc.dryer.title': 'Ремонт сушильных машин',
    'be.svc.dryer.text': 'Мы диагностируем и ремонтируем неисправности нагревательного элемента, теплового насоса, вентилятора, датчика влажности и электронной платы в сушильных машинах — всё с гарантией.',
    'be.svc.oven.title': 'Ремонт духовок, варочных панелей и встроенной техники',
    'be.svc.oven.text': 'Ремонт нагревательных элементов, термостатов, поджига, газовых клапанов и электронных плат для духовок, которые не нагревают, варочных панелей, которые не работают, неисправных встроенных комплектов и вытяжек. Все газовые и электрические модели.',
    'be.svc.other.title': 'Морозильные камеры и другая техника',
    'be.svc.other.text': 'Мы также обслуживаем морозильные камеры, микроволновые печи, вытяжки и другую бытовую технику. Позвоните нам с деталями неисправности, и мы направим подходящую бригаду к вам в тот же день.',
    'be.brands.tag': 'Марки, которые мы обслуживаем',
    'be.brands.title': 'Все марки бытовой техники',
    'be.brands.desc': 'Мы обслуживаем всю вашу бытовую технику независимо от марки. Поставляем оригинальные и совместимые запчасти.',
    'be.brands.note': 'Даже если вы не видите свою марку в списке, позвоните — скорее всего, она входит в наш сервис.',
    'be.why.tag': 'Почему Güneş Klima?',
    'be.why.title': 'Почему мы для сервиса бытовой техники?',
    'be.why.desc': 'Благодаря нашей мобильной службе по всей Алании мы предлагаем быстрые, надёжные и гарантированные решения для неисправностей вашей техники.',
    'be.why.card1.title': 'Обслуживание в тот же день',
    'be.why.card1.text': 'Благодаря быстрому круглосуточному выезду по всей Алании мы приезжаем к вам и ремонтируем технику в тот же день.',
    'be.why.card2.title': 'Гарантия на работу',
    'be.why.card2.text': 'Каждый ремонт и каждая замена детали имеют гарантию. Если та же неисправность повторится, мы рядом.',
    'be.why.card3.title': 'Сервис для всех марок',
    'be.why.card3.text': 'Мы обслуживаем технику Arçelik, Beko, Bosch, Siemens и всех других марок оригинальными и совместимыми запчастями.',
    'be.why.card4.title': 'Прозрачные цены',
    'be.why.card4.text': 'После диагностики мы озвучиваем точную цену заранее и не начинаем работу без вашего согласия. Никаких скрытых доплат.',
    'be.faq.tag': 'Часто задаваемые вопросы',
    'be.faq.title': 'Вопросы о ремонте бытовой техники',
    'be.faq.desc': 'Мы ответили на самые частые вопросы о неисправностях холодильников, стиральных и посудомоечных машин.',
    'be.faq.q1.q': 'Почему мой холодильник не охлаждает?',
    'be.faq.q1.a': 'Неохлаждающий холодильник обычно связан с утечкой газа, неисправностью термостата, проблемой компрессора или засором в системе вентилятора/разморозки. В Алании мы приезжаем к вам в тот же день, диагностируем неисправность и выполняем заправку газом или замену деталей с гарантией.',
    'be.faq.q2.q': 'Что делать, если стиральная машина не набирает или не сливает воду?',
    'be.faq.q2.a': 'Отсутствие набора воды обычно связано с впускным клапаном, засором водяного фильтра или платой; отсутствие слива — с насосом, засором сливного шланга или неисправным сливным насосом. Наш сервис диагностирует неисправность на месте и устраняет её в тот же день.',
    'be.faq.q3.q': 'Посудомоечная машина показывает код ошибки — можно ли её отремонтировать?',
    'be.faq.q3.a': 'Да. Коды ошибок в посудомоечных машинах обычно указывают на неисправности впуска воды, нагрева, слива или датчиков. Независимо от марки мы считываем код, устраняем причину и заменяем необходимую деталь.',
    'be.faq.q4.q': 'Какие марки бытовой техники вы обслуживаете?',
    'be.faq.q4.a': 'Мы обслуживаем холодильники, стиральные и посудомоечные машины, сушилки, духовки и варочные панели Arçelik, Beko, Bosch, Siemens, Samsung, LG, Vestel, Profilo, Altus, Grundig, Whirlpool и всех других марок.',
    'be.faq.q5.q': 'Сколько стоит ремонт бытовой техники?',
    'be.faq.q5.a': 'Стоимость зависит от типа устройства, объёма неисправности и заменяемой детали. После диагностики мы озвучиваем точную цену до начала работ и не приступаем без вашего согласия. Никаких скрытых доплат.',
    'be.faq.q6.q': 'Вы предоставляете обслуживание в тот же день?',
    'be.faq.q6.a': 'Да. Мы предоставляем обслуживание в тот же день, круглосуточно, по всей Алании и её районам с нашими мобильными сервисными автомобилями. Все ремонты и замены деталей имеют гарантию.',
    'be.regions.tag': 'Ближайшие зоны обслуживания',
    'be.regions.title': 'Зоны сервиса бытовой техники',
    'be.regions.desc': 'С нашими мобильными сервисными автомобилями мы предоставляем сервис бытовой техники в тот же день во все районы Алании и окрестности.',
    'be.regions.note': 'Мы предоставляем быстрый круглосуточный мобильный сервис во все районы Алании и окрестные округа.',
    'be.contact.tag': 'Свяжитесь с нами',
    'be.contact.title': 'Обратитесь по поводу неисправности техники',
    'be.contact.desc': 'По поводу неисправности бытовой техники вы можете связаться с нами круглосуточно по телефону, WhatsApp или электронной почте. Без форм — позвоните напрямую для самого быстрого решения.',
    'be.details.noform.text': 'Неисправность бытовой техники требует срочного вмешательства. Чтобы помочь вам как можно быстрее, <strong>позвоните нам сейчас</strong> или свяжитесь <strong>через WhatsApp</strong> вместо заполнения формы.',
    'be.footer.desc': 'Ваш профессиональный партнёр в Алании, предлагающий надёжные круглосуточные услуги по обслуживанию кондиционеров и бытовой техники. Мы всегда готовы помочь с ремонтом холодильников, стиральных и посудомоечных машин, духовок и всей бытовой техники.',
    'be.footer.brands': 'Обслуживаемые бренды'
  };
